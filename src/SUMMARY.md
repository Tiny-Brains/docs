...
- [Ants](games/ants.md)
  - [The world](games/ants/world.md)
  - [A turn](games/ants/turn.md)
  - [Ending and scoring](games/ants/scoring.md)
  - [The maps](games/ants/maps.md)

# Building a model

- [What your model sees](models/observation.md)
- [What your model answers](models/actions.md)
...
- [Matches](competing/matches.md)
- [Replays](competing/replays.md)
...
- [Limits and budgets](reference/limits.md)
- [HTTP API](reference/api.md)
- [Glossary](reference/glossary.md)

# The platform

- [How TinyBrains is built](platform/architecture.md)
- [The repositories](platform/repositories.md)
- [Running the platform locally](platform/running-locally.md)
- [Adding a game](platform/adding-a-game.md)
- [Contributing](platform/contributing.md)
